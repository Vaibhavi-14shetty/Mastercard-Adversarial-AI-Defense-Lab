...
def test_valid_transaction_succeeds(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "C0001",
...
def test_new_device_and_merchant_still_succeeds(client):
...
def test_nonexistent_customer_is_rejected(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "C9999",
...
def test_malformed_customer_id_rejected(client):
    r = client.post(
        "/simulate",
        json={
...
def test_empty_string_customer_id_rejected(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "",
...
def test_lowercase_customer_id_rejected(client):
...
def test_whitespace_only_merchant_id_rejected(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "C0001",
...
def test_malformed_beneficiary_id_rejected(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "C0001",
...
def test_null_beneficiary_id_is_fine(client):
...
def test_zero_amount_returns_422(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "C0001",
...
def test_extremely_large_amount_is_accepted(client):
...
def test_amount_as_string_returns_422(client):
...
def test_missing_multiple_required_fields_returns_422(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "C0001",
...
def test_extra_unexpected_field_is_ignored_not_rejected(client):
...
def test_all_valid_payment_methods_accepted(client):
...
def test_attack_id_is_passed_through(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "C0001",
...
def test_is_fraud_always_false_from_simulator(client):
...
def test_response_matches_frozen_schema_fields(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "C0001",
...
def test_currency_always_inr(client):
    r = client.post(
        "/simulate",
        json={
            "customer_id": "C0001",
...
def test_health_check_reports_customer_count(client):
    r = client.get("/health")
    assert r.status_code == 200
